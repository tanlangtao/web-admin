            ...
            {data.map((room) => {
                ...
                return (<Form
                    ...
                    <div style={{ paddingLeft: "30px", backgroundColor: "#eee" }}>
                        房间号：{room.Index}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{roomLevel}元房&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;玩家总赢：{room.TotalWin.toFixed(4)}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;玩家总输：{room.TotalLose.toFixed(4)}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;差额(玩家总输-玩家总赢):&nbsp;&nbsp;<span style={room.TotalLose - room.TotalWin < 0 ? { color: "red" } : { color: "black" }}>{(room.TotalLose - room.TotalWin).toFixed(4)}</span>
                    </div>
