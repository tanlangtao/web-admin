...
import { Card, Table, Modal, message, Icon, Select, Input, Popconfirm, Button } from "antd";
		...
		return (
			<Card title={title} extra={extra}>
				...
				{this.state.isNickShow && (
					...
					>
						<WrappedNormalLoginForm ref="getFormValue" val={this.game_nick} isNickModal />
					</Modal>
				)}
				...
				{this.state.isGoldDetailShow && (
					<Modal
						title={this.isBindInfo ? "查看绑定信息" : `[用户user_id:${this.recordID}]资金明细`}
