	...
	return (
		<div>
			<div style={{ fontSize: 16, backgroundColor: "#ddd" }}>
				&nbsp;&nbsp;玩家总充值：{reverseNumber(total_payment_arrival_amount) || 0}
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;玩家总兑换：
				{reverseNumber(total_with_draw_amount) || 0}
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;充值兑换差：
				{reverseNumber(total_payment_arrival_amount - total_with_draw_amount) || 0}
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总流水：
		...
		try {
			switch (pay_account_id) {
				...
				case "5b1f3a3cb76a591e7f251721":
					...
					reactnode = (
						<Descriptions title={`房间ID:${data.room_id}`} bordered size="small">
				...
				case "5b1f3a3cb76a591e7f2517a6":
					reactnode = (
						<Descriptions title={`房间ID:${data.round_id}`} bordered size="small">
							<Descriptions.Item label="房间等级" span={3}>
								{data.roomLevel === 1
									? "体验房"
									: data.roomLevel === 2
					...
					reactnode = (
						<>
							<Descriptions
								...
								column={1}
							>
								<Descriptions.Item label="税收">{data.tax_rate}</Descriptions.Item>
							...
							>
								...
								<Descriptions.Item label="梅花">
									...
									<div>組成牌型 : {reverse_niuniu(data.card.three.cardtype)}</div>
								...
								<Descriptions.Item label="方块">
									...
									<div>組成牌型 : {reverse_niuniu(data.card.four.cardtype)}</div>
					...
					if (data.Dealer === `${id}`) {
						...
						reactnode = (
							<Descriptions bordered size="small">
								...
								<Descriptions.Item label="下注信息" span={3}>
									<div>顺:{find(data.Shun.Bets, { PlayerID: `${id}` })?.Bet}</div>
									<div>天:{find(data.Tian.Bets, { PlayerID: `${id}` })?.Bet}</div>
					...
					reactnode = (
						<div>
							<Descriptions bordered size="small" column={1}>
								<Descriptions.Item label="房间类型">{data.level}</Descriptions.Item>
								<Descriptions.Item label="底分">{data.basepoint}</Descriptions.Item>
					...
					reactnode = (
						<>
							<Descriptions
								...
								column={1}
							>
								<Descriptions.Item label="税率">{data.TaxRate}</Descriptions.Item>
					...
					reactnode = (
						<>
							<Descriptions
								...
								column={1}
							>
								<Descriptions.Item label="当局开奖">{data.prize}</Descriptions.Item>
								<Descriptions.Item label="税收">{data.tax_rate}</Descriptions.Item>
